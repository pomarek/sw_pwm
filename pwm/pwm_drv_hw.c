...
const pwm_output_t gpio_desc[PWM_CHANNELS] =
{
		...
		{GPIO1_CLEARDATAOUT, _BIT(19)},
		{GPIO1_CLEARDATAOUT, _BIT(18)},
		{GPIO1_CLEARDATAOUT, _BIT_EMPTY},
		{GPIO2_CLEARDATAOUT, _BIT_EMPTY},
		...
		{GPIO0_CLEARDATAOUT, _BIT_EMPTY},
		{GPIO2_CLEARDATAOUT, _BIT_EMPTY},

		{GPIO1_CLEARDATAOUT, _BIT(6)},
		{GPIO1_CLEARDATAOUT, _BIT(2)},
		{GPIO2_CLEARDATAOUT, _BIT(2)},
		{GPIO0_CLEARDATAOUT, _BIT(27)},

		{GPIO0_CLEARDATAOUT, _BIT(22)},
		{GPIO1_CLEARDATAOUT, _BIT(30)},
		{GPIO3_CLEARDATAOUT, _BIT_EMPTY},
		{GPIO3_CLEARDATAOUT, _BIT_EMPTY},

		{GPIO2_CLEARDATAOUT, _BIT(5)},
		{GPIO0_CLEARDATAOUT, _BIT(23)},
		{GPIO0_CLEARDATAOUT, _BIT_EMPTY},
		{GPIO0_CLEARDATAOUT, _BIT_EMPTY},
